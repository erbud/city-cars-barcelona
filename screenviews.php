...
<head>
    ...
    <script type="text/javascript" src="/js/citycars.js"></script>
</head>
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <div class="info-app">
                <h2 class="title">
                    <?= _str('screenviews.title') ?>
                </h2>
                <ul class="screenshots-examples">
                    <li><img src="images/screenshot-01.png" width="480" height="320" alt="" class="item" /></li>
                    <li><img src="images/screenshot-02.png" width="480" height="320" alt="" class="item" /></li>
                    <li><img src="images/screenshot-03.png" width="480" height="320" alt="" class="item" /></li>
                    <li><img src="images/screenshot-04.png" width="480" height="320" alt="" class="item" /></li>
                    <li><img src="images/screenshot-05.png" width="480" height="320" alt="" class="item" /></li>
                    <li><img src="images/screenshot-06.png" width="480" height="320" alt="" class="item" /></li>
                    <li><img src="images/screenshot-07.png" width="480" height="320" alt="" class="item" /></li>
                    <li><img src="images/screenshot-08.png" width="480" height="320" alt="" class="item" /></li>
                </ul>
            </div>
            <div class="download">
                <ul class="stores">
